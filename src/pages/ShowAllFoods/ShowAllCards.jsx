        ...
        <div>
            <div className="max-w-md rounded-md shadow-md bg-gray-900 text-gray-100">
                ...
                <div className="flex flex-col justify-between p-4 space-y-6">
					...
					<button type="button" className="flex items-center justify-center w-full p-3 font-semibold tracki rounded-md hover:bg-green-400 bg-green-800 text-white ">View Detail</button>
					</Link>
                </div>
            </div>
        </div>
